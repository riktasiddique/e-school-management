...
<head>
    ...
    <title>{{config('app.name')}} | Teacher Login Panel</title>
                    ...
                    <div class="hpanel">
                        <div class="panel-body">
                            <form method="POST" action="">
                                ...
                                <div class="form-group">
                                    <label class="control-label" for="username">Joined Id</label>
                                    <input type="text" placeholder="Enter Join Id" title="Please enter you username" required="" value="" name="join_id" id="username" class="form-control" value:={{old('join_id')}}>
